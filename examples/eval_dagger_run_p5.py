...
handover_sim2real.dagger5.setup.build_phase5_context — the same call the training
...
from handover_sim2real.dagger5 import (          # noqa: E402
    evaluate_policy,
    export_run_dir,
    load_policy_runner,
)
...
EVAL_FIELDS = [
    ...
    "mean_close_step",
    # Phase 5 — same names and same order as dagger_log.csv, so plot_dagger_run_p5
...
from train_dagger_phase5 import EVAL_REASONS, reason_columns   # noqa: E402
...
def main() -> None:
    ...
    ctx = build_phase5_context(cfg4, seed=seed)
