...
from handover_sim2real.bc5 import (
    ACTTrainer,
    BCDataset,
    BCSequenceDataset,
    BCTrainer,
...
from handover_sim2real.dagger5 import (
    build_box_params,
    CollectParams,
    EvalParams,
    build_policy,
...
from handover_sim2real.dagger5.setup import build_phase5_context, scene_pools
...
def main() -> None:
    ...
    if int(args.num_workers) > 1:
        from handover_sim2real.dagger5.parallel import ParallelDaggerCollector
