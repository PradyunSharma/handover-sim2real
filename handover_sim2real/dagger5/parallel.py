...
DETERMINISM. The MANAGER picks the (scene, grasp) pairs (train_dagger_phase5's
...
def _worker_main(worker_id, cfg4, seed, worker_device, task_q, result_q):
    ...
    try:
        ...
        from handover_sim2real.dagger5.collector import collect_dagger_episode
        from handover_sim2real.dagger5.policy_io import load_policy_runner
        from handover_sim2real.dagger5.setup import build_phase5_context
        ...
        ctx = build_phase5_context(cfg4, seed=seed, verbose=False)
